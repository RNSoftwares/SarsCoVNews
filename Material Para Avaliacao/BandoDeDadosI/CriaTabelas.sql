...
CREATE TABLE Usuario (idusu SERIAL NOT NULL, nomusu varchar(50) NOT NULL, cpfusu varchar(15) NOT NULL, rgusu varchar(15) NOT NULL, idausu int4 NOT NULL, altusu float4 NOT NULL, telusu numeric(19, 0) NOT NULL, pesusu float4 NOT NULL, tipsanusu varchar(3) NOT NULL, sexusu char(1) NOT NULL, ruausu varchar(255) NOT NULL, numusu int4 NOT NULL, baiusu varchar(255) NOT NULL, idpai int4 NOT NULL, idest int4 NOT NULL, logace varchar(255) NOT NULL, codcid int4 NOT NULL, PRIMARY KEY (idusu));
